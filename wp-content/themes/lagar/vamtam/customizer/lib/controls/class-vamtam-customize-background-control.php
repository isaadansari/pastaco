...
class Vamtam_Customize_Background_Control extends Vamtam_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->button_labels = wp_parse_args( $this->button_labels, array(
			'select'       => esc_html__( 'Select Image', 'lagar' ),
			'change'       => esc_html__( 'Change Image', 'lagar' ),
			'remove'       => esc_html__( 'Remove', 'lagar' ),
			'default'      => esc_html__( 'Default', 'lagar' ),
			'placeholder'  => esc_html__( 'No image selected', 'lagar' ),
			'frame_title'  => esc_html__( 'Select Image', 'lagar' ),
			'frame_button' => esc_html__( 'Choose Image', 'lagar' ),
		) );
		...
		self::$selects = array(
			'background-repeat' => array(
				'no-repeat' => esc_html__( 'No repeat', 'lagar' ),
				'repeat-x'  => esc_html__( 'Repeat horizontally', 'lagar' ),
				'repeat-y'  => esc_html__( 'Repeat vertically', 'lagar' ),
				'repeat'    => esc_html__( 'Repeat both', 'lagar' ),
			),
			'background-attachment' => array(
				'scroll' => esc_html__( 'scroll', 'lagar' ),
				'fixed'  => esc_html__( 'fixed', 'lagar' ),
			),
			'background-size' => array(
				'auto'    => esc_html__( 'auto', 'lagar' ),
				'cover'   => esc_html__( 'cover', 'lagar' ),
				'contain' => esc_html__( 'contain', 'lagar' ),
			),
			'background-position' => array(
				'left top'      => esc_html__( 'left top', 'lagar' ),
				'left center'   => esc_html__( 'left center', 'lagar' ),
				'left bottom'   => esc_html__( 'left bottom', 'lagar' ),
				'center top'    => esc_html__( 'center top', 'lagar' ),
				'center center' => esc_html__( 'center center', 'lagar' ),
				'center bottom' => esc_html__( 'center bottom', 'lagar' ),
				'right top'     => esc_html__( 'right top', 'lagar' ),
				'right center'  => esc_html__( 'right center', 'lagar' ),
				'right bottom'  => esc_html__( 'right bottom', 'lagar' ),
			),
		);
	}
	...
	public function to_json() {
		...
		$this->json['alt_medium']    = esc_html__( 'Medium-sized attachment', 'lagar' );
		$this->json['alt_full']      = esc_html__( 'Full-sized attachment', 'lagar' );

		$this->json['option_labels'] = array(
			'background-type'       => esc_html__( 'Background Type', 'lagar' ),
			'background-repeat'     => esc_html__( 'Repeat', 'lagar' ),
			'background-image'      => esc_html__( 'Image', 'lagar' ),
			'background-attachment' => esc_html__( 'Attachment', 'lagar' ),
			'background-size'       => esc_html__( 'Size', 'lagar' ),
			'background-position'   => esc_html__( 'Position', 'lagar' ),
			'background-color'      => esc_html__( 'Color', 'lagar' ),
			'background-gradient'   => [
				'color-1'              => esc_html__( 'Color 1', 'lagar' ),
				'color-2'              => esc_html__( 'Color 2', 'lagar' ),
				'location'             => esc_html__( 'Location', 'lagar' ),
				'type'                 => esc_html__( 'Type', 'lagar' ),
				'position'             => esc_html__( 'Position', 'lagar' ),
				'angle'                => esc_html__( 'Angle', 'lagar' ),
			],
		);
		...
		$this->json['l10n'] = array(
			'background-gradient'   => [
				'type'              => [
					'linear' => esc_html__( 'Linear', 'lagar' ),
					'radial' => esc_html__( 'Radial', 'lagar' ),
				],
				'position'          => [
					'center center' =>  esc_html__( 'Center Center' , 'lagar' ),
					'center left'   =>  esc_html__( 'Center Left' , 'lagar' ),
					'center right'  =>  esc_html__( 'Center Right' , 'lagar' ),
					'top center'    =>  esc_html__( 'Top Center' , 'lagar' ),
					'top left'      =>  esc_html__( 'Top Left' , 'lagar' ),
					'top right'     =>  esc_html__( 'Top Right' , 'lagar' ),
					'bottom center' =>  esc_html__( 'Bottom Center' , 'lagar' ),
					'bottom left'   =>  esc_html__( 'Bottom Left' , 'lagar' ),
					'bottom right'  =>  esc_html__( 'Bottom Right' , 'lagar' ),
				],
			],
		);
