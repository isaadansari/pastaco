...
function vamtam_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'     => esc_html__( 'WooCommerce', 'lagar' ),
			'slug'     => 'woocommerce',
			'required' => true,
			'category' => 'required',
		),
		...
		array(
			'name'     => esc_html__( 'Elementor', 'lagar' ),
			'slug'     => 'elementor',
			'required' => true,
			'category' => 'required',
			'version'  => '2.7.4',
		...
		array(
			'name'     => esc_html__( 'Vamtam Elementor Integration', 'lagar' ),
		...
		array(
			'name'     => esc_html__( 'Vamtam Importers (E)', 'lagar' ),
		...
		array(
			'name'     => esc_html__( 'Wordpress SEO', 'lagar' ),
			'slug'     => 'wordpress-seo',
			'required' => false,
		...
		array(
			'name'     => esc_html__( 'Really Simple SSL', 'lagar' ),
		...
		array(
			'name'     => esc_html__( 'Loco Translate', 'lagar' ),
			'slug'     => 'loco-translate',
			'required' => false,
			'category' => 'recommended',
		),
		...
		array(
			'name'     => esc_html__( 'UpDraftPlus', 'lagar' ),
			'slug'     => 'updraftplus',
			'required' => false,
			'category' => 'recommended',
		),
		...
		array(
			'name'     => esc_html__( 'LiteSpeed Cache', 'lagar' ),
		...
		array(
			'name'     => esc_html__( 'Limit Login Attempts Reloaded', 'lagar' ),
		...
		array(
			'name'     => esc_html__( 'Wordfence', 'lagar' ),
			'slug'     => 'wordfence',
			'required' => false,
			'category' => 'recommended',
		),
		...
		array(
			'name'     => esc_html__( 'CookieYes | GDPR Cookie Consent & Compliance Notice (CCPA Ready)', 'lagar' ),
...
function vamtam_tgmpa_table_columns( $columns ) {
	...
	$columns = array(
		...
		'img'         => '',
		'plugin'      => esc_html__( 'Name', 'lagar' ),
		'description' => esc_html__( 'Description', 'lagar' ),
		'status'      => esc_html__( 'Status', 'lagar' ),
		'version'     => esc_html__( 'Version', 'lagar' ),
	);
	return $columns;
}
...
function vamtam_tgmpa_table_data_item( $item, $plugin )
{
	...
	if( isset( $plugin_data['Description'] ) ) {
		...
		$item['description'] =  esc_html__( 'A simple WordPress Plugin.', 'lagar' );
	}
	if ( strpos( $plugin['slug'], 'lagar' ) !== false ) {
		$item['description'] =  esc_html__( 'Theme Exclusive.', 'lagar' );
	}
...
function vamtam_tgmpa_admin_menu_args( $args ) {
	$args['page_title'] = esc_html__( 'Install Plugins', 'lagar' );
