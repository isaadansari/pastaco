...
class VamtamFramework {
	...
	public static function theme_supports() {
		...
		if ( function_exists( 'register_nav_menus' ) ) {
			register_nav_menus(
				array(
					'primary-menu'     => esc_html__( 'Menu Header', 'lagar' ),
				)
			);
		}
	}
	...
	private function load_languages() {
		load_theme_textdomain( 'lagar', VAMTAM_THEME_DIR . 'languages' );
	}
	...
	public static function license_valid() {
		...
		esc_html_e( 'Valid Purchase Key.', 'lagar' );
		echo '<p>';
		esc_html_e( 'Congratulations! You have succesfully registered your product.', 'lagar' );
		echo '</p>';
		echo '</span>';
	}
	...
	public static function license_invalid() {
		echo '<span id="fail">';
		esc_html_e( 'Incorrect Purchase Key.', 'lagar' );
		echo '<p>';
		esc_html_e( 'Please check your purchase code and re-enter.', 'lagar' );
		echo '</p>';
		echo '</span>';
	}
	...
	public static function license_failed() {
		...
		esc_html_e( 'Cannot validate Purchase Key. Please try again later. If the problem persists your server might not have the curl PHP extension enabled.', 'lagar' );
		echo '</span>';
	}
	...
	public static function license_unregister() {
		esc_html_e( 'Unregistered Key.', 'lagar' );
	}
}
