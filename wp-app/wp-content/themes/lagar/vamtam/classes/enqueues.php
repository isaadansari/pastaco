	...
	public static function admin_scripts() {
		...
		wp_localize_script(
			'vamtam-admin', 'VAMTAM_ADMIN', array(
				'addNewIcon' => esc_html__( 'Add New Icon', 'lagar' ),
				'iconName'   => esc_html__( 'Icon', 'lagar' ),
				'iconText'   => esc_html__( 'Text', 'lagar' ),
				'iconLink'   => esc_html__( 'Link', 'lagar' ),
				'iconChange' => esc_html__( 'Change', 'lagar' ),
