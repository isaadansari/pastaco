...
class Vamtam_Customize_Typography_Control extends Vamtam_Customize_Control {
	...
	public function to_json() {
		...
		$this->json['l10n'] = array(
			'font-family'                => esc_html__( 'Font Family', 'lagar' ),
			'select-font-family'         => esc_html__( 'Select Font Family', 'lagar' ),
			'font-weight'                     => esc_html__( 'Weight', 'lagar' ),
			'transform'                  => array (
				'label'        => esc_html__( 'Transform', 'lagar' ),
				'uppercase'    => esc_html__( 'Uppercase', 'lagar' ),
				'lowercase'    => esc_html__( 'Lowercase', 'lagar' ),
				'capitalize'   => esc_html__( 'Capitalize', 'lagar' ),
				'normal'       => esc_html__( 'Normal', 'lagar' ),
			),
			'font-style'                 => array (
				'label'        => esc_html__( 'Style', 'lagar' ),
				'normal'       => esc_html__( 'Normal', 'lagar' ),
				'italic'       => esc_html__( 'Italic', 'lagar' ),
				'oblique'      => esc_html__( 'Oblique', 'lagar' ),
			),
			'decoration'                 => array (
				'label'        => esc_html__( 'Decoration', 'lagar' ),
				'underline'    => esc_html__( 'Underline', 'lagar' ),
				'overline'     => esc_html__( 'Overline', 'lagar' ),
				'line-through' => esc_html__( 'Line Through', 'lagar' ),
				'none'         => esc_html__( 'None', 'lagar' ),
			),
			'font-size'                  => esc_html__( 'Font Size', 'lagar' ),
			'line-height'                => esc_html__( 'Line Height', 'lagar' ),
			'color'                      => esc_html__( 'Font Color', 'lagar' ),
			'letter-spacing'             => esc_html__( 'Letter Spacing', 'lagar' ),
			'letter-spacing-description' => wp_kses( __( 'Either <code>normal</code> or a length unit', 'lagar' ), [ 'code' => [] ] ),
		);
	}
	/**
